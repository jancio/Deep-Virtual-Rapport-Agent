...
#
#     Uses the train and val partitions of the 4comb dataset for training and validation. 
#     The test set is untouched => can be used to evaluate the developed Head Gesture Detector on the same dataset 
#                                  (namely, on the 4comb test partition)
#
#     Used with all head gestures (nod, shake, tilt)
#         => 3 HGD models were trained.
#
#     Model checkpoints (.hdf) and training history (.pkl) files are saved to the ./checkpoints/4comb folder.
...
#
#     Run as:
#         python train_4comb_hgd.py {CUDA_VISIBLE_DEVICES} {GPU_MEMORY_FRACTION} {number_of_features} {N_GRU_UNITS} {head_gesture}
#                                                                                      6 or 12
#     E.g. 
#         python train_4comb_hgd.py 3 0.65 12 32 nod
#######################################################################################################################
...
parser.add_argument("N_GRU_UNITS", help="N_GRU_UNITS", type=int)
...
model_checkpoint_path_prefix = f'./checkpoints/4comb/'

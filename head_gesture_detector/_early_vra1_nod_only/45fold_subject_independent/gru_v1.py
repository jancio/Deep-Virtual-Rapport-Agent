...
def evaluate_custom_metrics(Y_true, Y_pred, chunk_lens, window_size):
...
class CustomMetrics(Callback):
    ...
    '''
    def __init__(self, val_lens, window_size):
...
for WINDOW_SIZE in window_sizes_range:
    ...
    for k in range(n_folds):
        ...
        custom_metrics = CustomMetrics(val_lens=data['val_len'], window_size=WINDOW_SIZE)

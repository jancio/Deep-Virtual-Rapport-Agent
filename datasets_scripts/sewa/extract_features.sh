...
input_dir=~/dvra_datasets/sewa/original_data
output_dir=~/dvra_datasets/sewa/openface_features
output_log=~/dvra_datasets/sewa/feature_extraction_time_log.txt
